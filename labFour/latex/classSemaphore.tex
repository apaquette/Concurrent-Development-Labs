...
\begin{DoxyCompactList}\small\item\em Closes thread based on a given amount of time. \end{DoxyCompactList}\item 
...
Closes thread based on a given amount of time. 


\begin{DoxyParams}{Parameters}
{\em cr\+Rel\+Time} & Time to wait for thread \\
\hline
\end{DoxyParams}
